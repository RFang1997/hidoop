...
public class Count {
	...
	public static void main(String[] args) {
		...
		try {
			...
			LineNumberReader lnr = new LineNumberReader(new InputStreamReader(new FileInputStream("/tmp/"+"data/"+args[0])));
			while (true) {
			...
			BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(Project.PATH+"data/"+"count-res")));
